<x-app-layout>
    ...
    <div class="py-12 bg-white min-h-screen mb-20">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <x-modern-progress :currentStep="3" :progress="75" />
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('tenants.final-preview') }}">
                        @csrf
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="text-sm">
                                    ...
                                    <p class="text-gray-500 mt-1 font-medium">
                                        By checking this box, you certify that <span
                                            class="uppercase font-bold text-slate-700">{{ $mockLease->tenant->full_name }}</span>
                                        has authorized this digital signature.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mt-12 flex items-center justify-between">
                            ...
                            <button type="submit"
                                class="group relative flex items-center justify-center px-10 py-5 bg-slate-900 text-white rounded-2xl overflow-hidden transition-all hover:bg-indigo-600 active:scale-95 shadow-2xl shadow-slate-200">
                                <span class="relative z-10 font-black tracking-widest uppercase text-xs">Authorize &
                                    Complete Registration</span>
                                <div
                                    class="absolute inset-0 bg-indigo-500 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out">
                                </div>
                            </button>
                        </div>
                    </form>
